      ...
      <div className="p-2 EventAdd">
        ...
        <div className="content">
                  ...
                  <div style={{ display: "flex" }}>
                    <div style={{ display: "flex" }}>
                      ...
                      <div>
                        ...
                        <div class="text-small">File size: Up to 5MB</div>
          ...
          <h4><span>Location</span></h4>
            ...
            <Row style={{ marginTop: "0.3rem" }}>
              <Col span={24} className="col-padding">
                <Card className="social-card card-box" style={{ width: "100%", }}            >
                  <div style={{ display: "flex" }}>
                    <div style={{ display: "flex" }}>
                      {/* <a>
                  <TwitterOutlined  className="social-icon"/>
                      ...
                      <div className="social-media-label" style={{ display: "flex" }}>
                        <div style={{ fontWeight: "600", fontSize: "16px", paddingRight: "2rem" }}><XOutlined className="social-icon twitter-bg-color" /> Twitter</div>
                        <div style={{ fontWeight: "600", fontSize: "16px", paddingRight: "2rem" }}>  <FacebookOutlined className="social-icon facebook-bg-color" /> Facebook</div>
                        <div style={{ fontWeight: "600", fontSize: "16px", paddingRight: "2rem" }}>  <LinkedinOutlined className="social-icon linkedin-bg-color" /> LinkedIn</div>
                        <div style={{ fontWeight: "600", fontSize: "16px", paddingRight: "2rem" }}> <YoutubeOutlined className="social-icon youtube-bg-color" /> YouTube</div>
                        <div style={{ fontWeight: "600", fontSize: "16px", paddingRight: "2rem" }}><InstagramOutlined className="social-icon insta-bg-color" /> Instagram</div>
